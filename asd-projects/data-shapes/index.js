$(document).ready(function () {
  ...
  var dataShapes = generateShapeData();
  var currentIndex = 0;
...
// Step 1: Create the new shape object
var shape = {
  color: "blue",
  shape: "circle",
  repeat: 3
...
// Step 2: Add the new shape object to the end of the dataShapes array
dataShapes.push(shape);

console.log(dataShapes);
console.log("Original array:", dataShapes);
  
// TODO 2: add a new property to all data shapes
  for (let i = 0; i < dataShapes.length; i++) {
  // Store the current object in the array
...
console.log("Updated array:", dataShapes);
